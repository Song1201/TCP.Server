...
testStructType test_struct;
resultStructType res_struct;
        ...
        else /* Data srrives on some other client FD*/
        {
            ...
            for(; i < MAX_CLIENT_SUPPORTED; i++){
                ...
                if(FD_ISSET(monitored_fd_set[i], &readfds)){/*Find the clinet FD on which Data has arrived*/
                    ...
                    testStructType *client_data = (testStructType *)data_buffer;
                    ...
                    sent_recv_bytes = sendto(comm_socket_fd, (char *)&result, sizeof(resultStructType), 0,
